...
var (
	apiCommand = cli.Command{
		...
		Description: `
	The api command allows you to communicate (via IPC) with a running demedallod instance
	...
	Examples:
		...
		$ demedallod api demedallo getBlockByNumber 123 true
		$ demedallod demedallo getBlockByNumber '"latest"' true
		$ demedallod --chain morden api demedallo sendTransaction '{"from": "0x396599f365093186742c17aab158bf515e978bc7", "gas": "0x5208", "gasPrice": "0x02540be400", "to": "0xa02cee0fc1d3fb4dde86b79fe93e4140671fd949"}'
