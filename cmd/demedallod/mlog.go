...
var mlogClientStartup = &logger.MLogT{
	Description: `Called when the demedallod client starts up.`,
	Receiver:    "CLIENT",
	Verb:        "START",
	Subject:     "SESSION",
...
var mlogClientShutdown = &logger.MLogT{
	Description: "Called when the demedallod client shuts down because of an interceptable signal, eg. SIGINT.",
	Receiver:    "CLIENT",
	Verb:        "STOP",
	Subject:     "SESSION",
