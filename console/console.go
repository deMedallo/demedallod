...
import (
	...
	"github.com/demedallo/demedallod/internal/jsre"
	"github.com/demedallo/demedallod/internal/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	flatten := "var demedallo = web3.demedallo; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
// Welcome show summary of current demedallod instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic demedallod metadata
	fmt.Fprintf(c.printer, "Welcome to the demedallod JavaScript console!\n\n")
	c.jsre.Run(`
		console.log("instance: " + web3.version.node);
		console.log("coinbase: " + demedallo.coinbase);
		console.log("at block: " + demedallo.blockNumber + " (" + new Date(1000 * demedallo.getBlock(demedallo.blockNumber).timestamp) + ")");
