...
var (
	...
	walletCommand = cli.Command{
		Name:  "wallet",
		Usage: "deMedallo presale wallet",
		Subcommands: []cli.Command{
			{
				Action: importWallet,
				Name:   "import",
				Usage:  "import demedallo presale wallet",
			},
		},
		Description: `

demedallod wallet import /path/to/my/presale.wallet
	...
	'$ demedallod account <command> --help' shows help for any subcommand.
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
demedallod account list

	Lists all accounts found in demedallod's keystore.
...
demedallod account new
	...
	For non-interactive use the passphrase can be specified with the --password flag:
		...
		demedallod --password <passwordfile> account new
...
demedallod account update <address>
	...
	For non-interactive use the passphrase can be specified with the --password flag:
		...
		demedallod --password <passwordfile> account update <address>
...
demedallod account import <keyfile>
	...
	For non-interactive use the passphrase can be specified with the -password flag:
		...
		demedallod --password <passwordfile> account import <keyfile>
