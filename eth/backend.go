...
import (
	...
	"github.com/demedallo/demedallod/common/compiler"
	"github.com/demedallo/demedallod/common/httpclient"
	"github.com/demedallo/demedallod/common/registrar/ethreg"
	...
	"github.com/demedallo/demedallod/eth/filters"
	...
	"github.com/demedallo/demedallod/p2p"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if !config.SkipBcVersionCheck {
		...
		if bcVersion != config.BlockChainVersion && bcVersion != 0 {
			return nil, fmt.Errorf("Blockchain DB version mismatch (%d / %d). Run demedallod upgradedb.\n", bcVersion, config.BlockChainVersion)
		}
